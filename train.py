...
def parse_args():
    ...
    parser.add_argument('-weight_decay', '--weight_decay', help='weight decay', type=float, default=0.05)
    parser.add_argument('-label_smoothing', '--label_smoothing', help='label smoothing', type=float, default=0.03)
    ...
    parser.add_argument('-dec_lr', '--dec_lr', help='learning rate of decoder', type=float, default=8e-3)
